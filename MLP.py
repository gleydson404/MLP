...
# Y = np.matrix([0, 1, 1, 0])
X, Y = read_data("CEN2_DATASET1.csv")
...
# np.savetxt("weightsA0.5", A, delimiter=',')
# np.savetxt("weightsB0.5", B, delimiter=',')
...
A = np.matrix(np.loadtxt("weightsA0.5", delimiter=','))
B = np.matrix(np.loadtxt("weightsB0.5", delimiter=','))
